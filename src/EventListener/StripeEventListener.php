...
#[AsEventListener(event: 'payment_intent.succeeded', method: 'onPaymentSucced')]
...
class StripeEventListener
{
    ...
    public function onPaymentSucced(StripeEvent $event): void
    {
        // On récupére la ressource de l'évènement
